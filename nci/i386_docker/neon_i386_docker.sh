...
#outputDir=i386_build
#suite=jammy
#arch=i386

apt install -y wget debuerreotype
wget https://partner-images.canonical.com/oci/jammy/current/ubuntu-jammy-oci-amd64-root.manifest
mv -f ubuntu-jammy-oci-amd64-root.manifest ubuntu-jammy-oci-i386-root.manifest
sed -i 's/amd64/i386/g' ubuntu-jammy-oci-i386-root.manifest
...
#test
#diff ubuntu-jammy-oci-i386-root.manifest i386_build/ubuntu/i386/jammy/rootfs.manifest/
